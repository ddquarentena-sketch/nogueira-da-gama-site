  ...
  return (
    <section ref={ref} className="relative py-20 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-[oklch(0.35_0.15_25)]/85" />
      </div>

      <div className={`container relative text-center transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        <h2
        ...
        <p className="text-white/80 max-w-xl mx-auto mb-8 text-base" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.2rem" }}>
